<?php
    ...
    // Define Date Filter
    $dateFilterResultFrom = $date->format(date('Y-m-d', strtotime($dateOnlyResult . " - 7 days")));
    $dateFilterResultTo = $dateOnlyResult;
    if (isset($_GET['fdt'])) {
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">GNG Virtual Tour</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item">
                                        <a href=""> Admin Dashboard <br></a>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-white mb-1 font-weight-medium"><?php echo $dashTotalVisitor; ?></h2>
                                    </div>
                                    <h6 class="text-light font-weight-normal mb-0 w-100 text-truncate">Total Visitors</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-white"><i data-feather="users"></i></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card border-right bg-success">
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        <h2 class="text-white mb-1 font-weight-medium"><?php echo $dashTotalVisitor2; ?></h2>
                                    </div>
                                    <h6 class="text-light font-weight-normal mb-0 w-100 text-truncate">Total Visitor (7d)</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                                    <span class="opacity-7 text-white"><i data-feather="users"></i></span>
                                </div>
                ...
                <div class="row" style="display: none">
                    ...
                    <div class="col-lg-9 text-right">
                        <a href="vrreport.php?fdt=<?php echo $dateFilterResultTo; ?>&fdf=<?php echo $dateFilterResultFrom; ?>" target="_blank"> <button type="button" class="btn waves-effect waves-light btn-primary mt-5" name="eBUpdate"><i class="fas fa-file"></i> &nbsp Generate Report  </button> </a>
                        <Br><Br>
                    </div>
                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <h4 class="card-title mb-0">Our Visitors</h4>
                                    <div class="ml-auto">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <h4 class="card-title mb-0">Top 3 Most Visited Facilities (Last 7d)</h4>
                                    <div class="ml-auto">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex align-items-start">
                                    <h4 class="card-title mb-0">Top 5 Visitor Cities (Last 7d)</h4>
                                    <div class="ml-auto">
